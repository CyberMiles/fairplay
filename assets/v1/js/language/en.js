var EnLanguage = {
//create.html
    create_title: "Create a giveaway",
    create_a_new: "Create a new giveaway",
    title: "Fair giveaways",
    title_helper: "Please provide a short title for your giveaway.",
    desc: "Description",
    desc_helper: "A longer description of the prize, and the purposes and procedures of this giveaway.",
    select_local:"Select from local",
    img_url:"Image URL",
    select_pic:"Select your picture",
    uploading:"Uploading......",
    upload_helper:"Upload a prize picutre. (jpg, jpeg, png and the size <= 2 MB.) ",
